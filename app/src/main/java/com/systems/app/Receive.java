...
//                String type= "Receiver";
                String type= Objects.requireNonNull(fAuth.getCurrentUser()).getEmail();

                if(TextUtils.isEmpty(fullname))
                {
                    mFullName.setError("Заголовок статьи обязателен для ввода");
                    return;
                }
                if(TextUtils.isEmpty(description))
                {
                    mFullName.setError("Текст статьи обязателен для ввода");
                    return;
                }
